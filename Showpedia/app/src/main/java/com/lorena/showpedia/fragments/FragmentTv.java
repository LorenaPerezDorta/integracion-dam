...
import com.lorena.showpedia.TvActivityDetail;
...
import com.lorena.showpedia.models.tv.TvResult;
import com.lorena.showpedia.adapters.tv.TvShowAdapter;
...
public class FragmentTv extends Fragment implements OnItemClickListener<Integer>, SwipeRefreshLayout.OnRefreshListener, SearchView.OnQueryTextListener {
    ...
    private void search(String tittle, int page){
        ...
        Call<TvResult> searchTvShowCall = searchService.searchTv(Consts.APIKEY, tittle, page);
