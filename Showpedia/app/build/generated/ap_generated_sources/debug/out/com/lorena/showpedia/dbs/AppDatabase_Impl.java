...
import com.lorena.showpedia.dbs.dao.FavoriteDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoFavoritesMovie.equals(_existingFavoritesMovie)) {
          return new RoomOpenHelper.ValidationResult(false, "favorites_movie(com.lorena.showpedia.dbs.table.FavoriteMovie).\n"
                  + " Expected:\n" + _infoFavoritesMovie + "\n"
        ...
        if (! _infoFavoritesTv.equals(_existingFavoritesTv)) {
          return new RoomOpenHelper.ValidationResult(false, "favorites_tv(com.lorena.showpedia.dbs.table.FavoriteTv).\n"
                  + " Expected:\n" + _infoFavoritesTv + "\n"
