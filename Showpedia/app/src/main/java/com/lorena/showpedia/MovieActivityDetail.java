...
import com.lorena.showpedia.dbs.AppDatabase;
import com.lorena.showpedia.dbs.table.FavoriteMovie;
import com.lorena.showpedia.models.movie.MovieDetail;
...
public class MovieActivityDetail extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(!exists){
            menu.getItem(0).setIcon(ContextCompat.getDrawable(this,R.drawable.ic_action_bar_favorite_border_24));
        }else{
            menu.getItem(0).setIcon(ContextCompat.getDrawable(this,R.drawable.ic_action_bar_favorite_24));
        }
        return true;
    }
}