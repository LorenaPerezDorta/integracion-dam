package com.lorena.showpedia.adapters.movie;
...
import com.lorena.showpedia.models.movie.Movie;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onBind(Movie movie, Context mContext){
            ...
            ivIsBookmarked.setImageResource(AppDatabase.getInstance(mContext).favoriteDao().isMovieExists(tvId)? R.drawable.ic_action_bar_favorite_24 : R.drawable.ic_action_bar_favorite_border_24);
        }
