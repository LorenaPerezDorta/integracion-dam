package com.lorena.showpedia.adapters.tv;
...
import com.lorena.showpedia.models.tv.TvShow;
...
public class TvShowAdapter extends RecyclerView.Adapter<TvShowAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onBind(TvShow tvShow, Context context){
            ...
            ivIsBookmarked.setImageResource(AppDatabase.getInstance(mContext).favoriteDao().isTvExists(tvId)? R.drawable.ic_action_bar_favorite_24 : R.drawable.ic_action_bar_favorite_border_24);
        }
